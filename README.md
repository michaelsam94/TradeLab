...
![Release APK](https://github.com/michaelsam94/TradeLab/actions/workflows/android-release.yml/badge.svg)
...
<table>
  <tr>
    <td><img src="play-store/phone/01_markets.png" alt="Live markets screen" width="220"></td>
    <td><img src="play-store/phone/02_trade_ticket.png" alt="Virtual trade ticket screen" width="220"></td>
    <td><img src="play-store/phone/03_indicator_feed.png" alt="Indicator feed screen" width="220"></td>
    <td><img src="play-store/phone/04_history_analytics.png" alt="History and analytics screen" width="220"></td>
  </tr>
</table>
...
| `.github/workflows/android-release.yml` | GitHub Actions pipeline for tag-triggered test, APK build, artifact upload, and release creation. | Push required. |
| `play-store/` | Google Play listing graphics and listing copy. | No app restart required. |
...
│           └── *.kt                     # JVM unit tests
├── .github/workflows/
│   └── android-release.yml              # Tag-triggered APK build and GitHub release
...
│   ├── tablet/                          # 1600×2560 tablet screenshots
│   └── listing-descriptions.md          # Play Console listing copy
...
GitHub Actions is configured in `.github/workflows/android-release.yml`. Pushing a semantic version tag such as `v1.0.0`
runs unit tests, builds `app-debug.apk`, uploads it as an artifact, and attaches it to a GitHub Release. This is a debug
APK pipeline because release signing keys are not configured in the repository.
